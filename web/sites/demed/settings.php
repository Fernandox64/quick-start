 ...
 * @endcode
 */
// Valor de dev local (DDEV) - nunca use este mesmo salt em producao.
// Em producao, HASH_SALT no .env sobrescreve isso via settings.local.php
// (ver docker/entrypoint.sh).
$settings['hash_salt'] = 'ddev-local-only-troque-em-producao-via-env-demed';
...
$settings['config_sync_directory'] = 'sites/demed/files/config_42b97nvcQgOZu-XjgLm73dSoQWyRAHW8rfukqhPa7-i3kY8H7xYjyiMm6m4qyV8ABEG-EtdxGQ/sync';
