...
CREATE DATABASE IF NOT EXISTS defarm;
GRANT ALL PRIVILEGES ON defarm.* TO 'db'@'%';
CREATE DATABASE IF NOT EXISTS denutri;
GRANT ALL PRIVILEGES ON denutri.* TO 'db'@'%';
CREATE DATABASE IF NOT EXISTS edfis;
GRANT ALL PRIVILEGES ON edfis.* TO 'db'@'%';
CREATE DATABASE IF NOT EXISTS deeco;
GRANT ALL PRIVILEGES ON deeco.* TO 'db'@'%';
CREATE DATABASE IF NOT EXISTS dedir;
GRANT ALL PRIVILEGES ON dedir.* TO 'db'@'%';
FLUSH PRIVILEGES;
