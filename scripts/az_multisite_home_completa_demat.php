...
/**
 * Reconstroi a home do DEMAT na mesma estrutura do site principal: banner
...
$nome_depto = 'Departamento de Matemática';

$boasVindas = Paragraph::create([
  'type' => 'az_text',
  'field_az_text_area' => [
    'value' => "<div class=\"az-ufop-hero az-ufop-hero-center\"><h2>Bem-vindo ao $nome_depto</h2><p>Site de demonstração de multisite - ensino, pesquisa e extensão em matemática.</p><div class=\"az-ufop-hero-actions\"><a class=\"btn btn-light\" href=\"/news\">Ver notícias</a> <a class=\"btn btn-outline-light\" href=\"/people\">Conheça a equipe</a></div></div>",
    'format' => 'full_html',
  ],
]);
$boasVindas->save();
...
$cardsServicos = Paragraph::create([
  ...
  'field_az_cards' => [
    ...
    ['title' => 'Nivelamento', 'body' => 'Aulas de reforço e nivelamento para alunos ingressantes.', 'body_format' => 'plain_text'],
  ],
]);
$cardsServicos->save();
...
$mediaId = az3_media_de_arquivo('public://imported/demat-noticias/banner_1.jpg', 'Quem somos');
